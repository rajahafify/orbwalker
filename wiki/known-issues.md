...
- M10-02 captured 3 human-played untuned baseline logs before tuning. The evidence shows mixed blockers: first-shop affordability can be weak, low-effectiveness play can die before shop access, and stronger runs still hit level 2-3 survivability pressure. M10-03 should add prototype balance levers before direct value tuning so economy and survivability changes can be compared against this baseline. (source: `docs/milestone_10_balance_tasks.md`, `docs/test_plan.md`)
