...
- First playable prototype vertical slice: a 3-level run with board combat, shop flow, boss rewards, and the initial content pack. (source: `todo.md`, `docs/game_design_document.md`)
