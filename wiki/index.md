...
- First playable prototype vertical slice: a 3-level run with board combat, shop flow, boss rewards, and the initial content pack. Architecture-review tasks AR-01 through AR-18 are closed, so the next major project focus is Milestone 10 balance and QA. (source: `todo.md`, `docs/game_design_document.md`, `docs/architecture_review_tasks.md`)
