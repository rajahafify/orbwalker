...
const ELEMENT_FONT_MIN_SIZE := 20
const STAT_TITLE_FONT_MIN_SIZE := 20
const STAT_VALUE_FONT_MIN_SIZE := 20
const FOOTER_FONT_MIN_SIZE := 20
const VERSION_FONT_MIN_SIZE := 20
const STATUS_FONT_MIN_SIZE := 20
