...
static func render(card: Button, visuals: Variant, relic_offer: Dictionary, treasure_chest_pending: bool) -> void:
	...
	SHOP_VIEW_CHROME_STYLER.make_price_badge(root, visuals, RELIC_PRICE_RECT, SHOP_COPY_FORMATTER.price_text(price, sold_out, affordable, treasure_chest_pending), disabled)
