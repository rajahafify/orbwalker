...
@export var vfx_light_indirect_energy : float = 1.0:
	set(v):
		vfx_light_indirect_energy = v
		vfx_indirect_energy = v

@export var vfx_light_volumetric_fog_energy : float = 1.0:
	set(v):
		vfx_light_volumetric_fog_energy = v
		vfx_volumetric_fog_energy = v
