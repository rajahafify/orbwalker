# Itch.io page header, cover, thumbnail, and embed art

Asset ID: itch_page_graphics
Type: marketing_pack
...
Prepare production candidate assets for Itch.io page header, cover, thumbnail, and embed art based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/itch_page_graphics.json.
- QA report target: assets/qa/reports/itch_page_graphics.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: marketing_pack
Primary request: Create production candidate art for Itch.io page header, cover, thumbnail, and embed art in Orbwalker, a fantasy match-3 roguelike.
