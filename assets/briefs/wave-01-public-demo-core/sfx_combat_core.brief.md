...
Prepare production candidate assets for Combat core SFX based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/sfx_combat_core.json.
- QA report target: assets/qa/reports/sfx_combat_core.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: sfx_set
Primary request: Create production candidate art for Combat core SFX in Orbwalker, a fantasy match-3 roguelike.
