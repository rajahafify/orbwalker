...
Prepare production candidate assets for Shop SFX based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/sfx_shop.json.
- QA report target: assets/qa/reports/sfx_shop.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: sfx_set
Primary request: Create production candidate art for Shop SFX in Orbwalker, a fantasy match-3 roguelike.
