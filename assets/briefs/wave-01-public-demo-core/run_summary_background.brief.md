# Victory/defeat run-summary background

Asset ID: run_summary_background
Type: background
...
Prepare production candidate assets for Victory/defeat run-summary background based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/run_summary_background.json.
- QA report target: assets/qa/reports/run_summary_background.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: background
Primary request: Create production candidate art for Victory/defeat run-summary background in Orbwalker, a fantasy match-3 roguelike.
