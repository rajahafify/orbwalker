...
Prepare production candidate assets for Production art bible based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/art_bible.json.
- QA report target: assets/qa/reports/art_bible.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: documentation
Primary request: Create production candidate art for Production art bible in Orbwalker, a fantasy match-3 roguelike.
