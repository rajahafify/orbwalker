...
Prepare production candidate assets for Generation metadata records based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/generation_metadata.json.
- QA report target: assets/qa/reports/generation_metadata.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: metadata_set
Primary request: Create production candidate art for Generation metadata records in Orbwalker, a fantasy match-3 roguelike.
