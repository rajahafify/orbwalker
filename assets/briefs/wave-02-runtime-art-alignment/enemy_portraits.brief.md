# Normal enemy portrait set

Asset ID: enemy_portraits
Type: enemy_portrait_set
...
Prepare production candidate assets for Normal enemy portrait set based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/enemy_portraits.json.
- QA report target: assets/qa/reports/enemy_portraits.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: enemy_portrait_set
Primary request: Create production candidate art for Normal enemy portrait set in Orbwalker, a fantasy match-3 roguelike.
