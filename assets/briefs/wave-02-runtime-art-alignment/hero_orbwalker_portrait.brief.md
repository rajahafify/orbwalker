# Orbwalker hero portrait

Asset ID: hero_orbwalker_portrait
Type: hero_portrait
...
Prepare production candidate assets for Orbwalker hero portrait based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/hero_orbwalker_portrait.json.
- QA report target: assets/qa/reports/hero_orbwalker_portrait.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: hero_portrait
Primary request: Create production candidate art for Orbwalker hero portrait in Orbwalker, a fantasy match-3 roguelike.
