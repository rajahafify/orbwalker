...
Prepare production candidate assets for Equipment item icons based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/equipment_icons.json.
- QA report target: assets/qa/reports/equipment_icons.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: icon_set
Primary request: Create production candidate art for Equipment item icons in Orbwalker, a fantasy match-3 roguelike.
