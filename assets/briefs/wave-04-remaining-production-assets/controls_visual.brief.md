# Controls/help visual

Asset ID: controls_visual
Type: instructional_graphic
...
Prepare production candidate assets for Controls/help visual based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/controls_visual.json.
- QA report target: assets/qa/reports/controls_visual.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: instructional_graphic
Primary request: Create production candidate art for Controls/help visual in Orbwalker, a fantasy match-3 roguelike.
