# Hero idle, hurt, attack-cast, victory, defeat animations

Asset ID: hero_animation_set
Type: animation_set
...
Prepare production candidate assets for Hero idle, hurt, attack-cast, victory, defeat animations based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/hero_animation_set.json.
- QA report target: assets/qa/reports/hero_animation_set.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: animation_set
Primary request: Create production candidate art for Hero idle, hurt, attack-cast, victory, defeat animations in Orbwalker, a fantasy match-3 roguelike.
