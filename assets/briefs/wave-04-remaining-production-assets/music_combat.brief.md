...
Prepare production candidate assets for Combat music loop based on assets.json while preserving the assetgen approval workflow.

## Current References

- res://resources/audio/music/combat.wav
- res://resources/audio/raw_music/combat.wav.bin
- res://raw/combat.mid
...
- Metadata record required: assets/generated/metadata/records/music_combat.json.
- QA report target: assets/qa/reports/music_combat.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: music
Primary request: Create production candidate art for Combat music loop in Orbwalker, a fantasy match-3 roguelike.
