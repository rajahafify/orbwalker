# Collection/meta progression background

Asset ID: collection_background
Type: background
...
Prepare production candidate assets for Collection/meta progression background based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/collection_background.json.
- QA report target: assets/qa/reports/collection_background.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: background
Primary request: Create production candidate art for Collection/meta progression background in Orbwalker, a fantasy match-3 roguelike.
