...
Prepare production candidate assets for Main menu music loop based on assets.json while preserving the assetgen approval workflow.

## Current References

- res://resources/audio/music/main-menu.wav
- res://resources/audio/raw_music/menu.wav.bin
- res://raw/main-menu.mid
...
- Metadata record required: assets/generated/metadata/records/music_menu.json.
- QA report target: assets/qa/reports/music_menu.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: music
Primary request: Create production candidate art for Main menu music loop in Orbwalker, a fantasy match-3 roguelike.
