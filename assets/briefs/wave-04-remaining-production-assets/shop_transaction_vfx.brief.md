# Shop buy, sell, reroll, treasure chest, and error feedback VFX

Asset ID: shop_transaction_vfx
Type: vfx_set
...
Prepare production candidate assets for Shop buy, sell, reroll, treasure chest, and error feedback VFX based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/shop_transaction_vfx.json.
- QA report target: assets/qa/reports/shop_transaction_vfx.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: vfx_set
Primary request: Create production candidate art for Shop buy, sell, reroll, treasure chest, and error feedback VFX in Orbwalker, a fantasy match-3 roguelike.
