# Consumable scroll icons

Asset ID: consumable_icons
Type: icon_set
...
Prepare production candidate assets for Consumable scroll icons based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/consumable_icons.json.
- QA report target: assets/qa/reports/consumable_icons.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: icon_set
Primary request: Create production candidate art for Consumable scroll icons in Orbwalker, a fantasy match-3 roguelike.
