# Six mastery card icons

Asset ID: mastery_icons
Type: mastery_icon_set
...
Prepare production candidate assets for Six mastery card icons based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/mastery_icons.json.
- QA report target: assets/qa/reports/mastery_icons.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: mastery_icon_set
Primary request: Create production candidate art for Six mastery card icons in Orbwalker, a fantasy match-3 roguelike.
