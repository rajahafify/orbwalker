# Enemy intent icon set

Asset ID: intent_icons
Type: intent_icon_set
...
Prepare production candidate assets for Enemy intent icon set based on assets.json while preserving the assetgen approval workflow.

## Current References

- res://resources/art/first_pass/derived/hud/intent_attack.png
- res://resources/art/first_pass/derived/hud/intent_block.png
- res://resources/art/first_pass/derived/hud/intent_attack_block.png
- res://resources/art/first_pass/sheets/intent_badge_set_v1.png
...
- Metadata record required: assets/generated/metadata/records/intent_icons.json.
- QA report target: assets/qa/reports/intent_icons.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: intent_icon_set
Primary request: Create production candidate art for Enemy intent icon set in Orbwalker, a fantasy match-3 roguelike.
