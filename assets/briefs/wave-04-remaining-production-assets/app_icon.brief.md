...
Prepare production candidate assets for Application icon based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/app_icon.json.
- QA report target: assets/qa/reports/app_icon.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: icon
Primary request: Create production candidate art for Application icon in Orbwalker, a fantasy match-3 roguelike.
