...
Asset ID: boss_portraits
Type: boss_portrait_set
...
Prepare production candidate assets for Boss portrait set based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/boss_portraits.json.
- QA report target: assets/qa/reports/boss_portraits.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: boss_portrait_set
Primary request: Create production candidate art for Boss portrait set in Orbwalker, a fantasy match-3 roguelike.
