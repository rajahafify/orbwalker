...
Prepare production candidate assets for Shared UI SFX based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/sfx_ui.json.
- QA report target: assets/qa/reports/sfx_ui.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: sfx_set
Primary request: Create production candidate art for Shared UI SFX in Orbwalker, a fantasy match-3 roguelike.
