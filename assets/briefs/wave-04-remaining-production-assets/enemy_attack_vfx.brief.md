# Enemy attack, block, shield, and HP-hit VFX

Asset ID: enemy_attack_vfx
Type: vfx_set
...
Prepare production candidate assets for Enemy attack, block, shield, and HP-hit VFX based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/enemy_attack_vfx.json.
- QA report target: assets/qa/reports/enemy_attack_vfx.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: vfx_set
Primary request: Create production candidate art for Enemy attack, block, shield, and HP-hit VFX in Orbwalker, a fantasy match-3 roguelike.
