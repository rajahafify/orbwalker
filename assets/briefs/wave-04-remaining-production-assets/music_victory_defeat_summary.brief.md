# Victory, defeat, and run-summary music stingers/loops

Asset ID: music_victory_defeat_summary
Type: music
...
Prepare production candidate assets for Victory, defeat, and run-summary music stingers/loops based on assets.json while preserving the assetgen approval workflow.

## Current References

- res://resources/audio/music/credit.wav
- res://raw/credit.mid
...
- Metadata record required: assets/generated/metadata/records/music_victory_defeat_summary.json.
- QA report target: assets/qa/reports/music_victory_defeat_summary.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: music
Primary request: Create production candidate art for Victory, defeat, and run-summary music stingers/loops in Orbwalker, a fantasy match-3 roguelike.
