# Tutorial, tooltip, first-run guidance, and control prompt UI

Asset ID: tutorial_onboarding_ui_pack
Type: ui_pack
...
Prepare production candidate assets for Tutorial, tooltip, first-run guidance, and control prompt UI based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/tutorial_onboarding_ui_pack.json.
- QA report target: assets/qa/reports/tutorial_onboarding_ui_pack.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: ui_pack
Primary request: Create production candidate art for Tutorial, tooltip, first-run guidance, and control prompt UI in Orbwalker, a fantasy match-3 roguelike.
