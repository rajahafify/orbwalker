# UI transition and feedback animation specifications

Asset ID: ui_motion_language
Type: motion_spec
...
Prepare production candidate assets for UI transition and feedback animation specifications based on assets.json while preserving the assetgen approval workflow.
...
- Metadata record required: assets/generated/metadata/records/ui_motion_language.json.
- QA report target: assets/qa/reports/ui_motion_language.qa.md.

## Prompt Starter

Use case: stylized-concept
Asset type: motion_spec
Primary request: Create production candidate art for UI transition and feedback animation specifications in Orbwalker, a fantasy match-3 roguelike.
